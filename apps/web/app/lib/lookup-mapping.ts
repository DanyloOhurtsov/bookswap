 ...
 *
 * Функція чиста й не викликається з ефекту. Компоненти передають її результат
 * лише як початкові значення форми, тож повторний рендер не перезаписує подальші
