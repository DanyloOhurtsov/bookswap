...
function TextField({ id, label, error, hint, ...input }: TextFieldProps) {
  return (
...
function TextAreaField({ id, label, error, hint, ...textarea }: TextAreaFieldProps) {
  return (
    <FieldShell id={id} label={label} error={error} hint={hint}>
      {({ describedBy, invalid }) => (
        <textarea
...
function SelectField({ id, label, error, hint, children, ...select }: SelectFieldProps) {
  return (
    <FieldShell id={id} label={label} error={error} hint={hint}>
      {({ describedBy, invalid }) => (
        <select
